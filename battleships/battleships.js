...
*/
var shiptypes = [["en Minensucher",2,4],["e Fregatte",3,4],[ "en Kreuzer",4,2],[ " Kriegsschiff",5,1]];
...
for (x=0;x<gridx;++x) {
if ( ispc )
document.write ('<a href="javascript:gridClick('+y+','+x+');"><img style="border-style: solid; border-width: 1px; border-color: #BBBEFF; cursor: crosshair" name="pc'+y+'_'+x+'" src="batt100.gif" width=16 height=16></a>');
else
document.write ('<a href="javascript:void(0);"><img style="border-style: solid; border-width: 1px; border-color: #BBBEFF; cursor: default" name="ply'+y+'_'+x+'" src="batt'+player[y][x][0]+'.gif" width=16 height=16></a>');
}
document.write('<br>');
   }
}
...
document.write("<center><table bgcolor=#000000><tr><td align=center><p class='heading'>COMPUTER FLOTTE</p></td>"+
"<td align=center><p class='heading'>SPIELER FLOTTE</p></td></tr><tr><td>");
showGrid(true);
document.write("</td><td>");
showGrid(false);
document.write("</td></tr></table></center><br>&nbsp; &bull; Spielen Sie Schiffe versenken gegen ihren Computer.<br>&nbsp; &bull; In der Statusleiste sehen Sie welche und wieviele Schiffe der Computer noch hat [Internet Explorer/Opera]");
document.write("<table align='center'><tr><th>Menge</th><th>Typ</th><th>Aussehen</th></tr><tr><td>1x</td><td>Kriegsschiff</td><td><img src='batt1.gif'><img src='batt2.gif'><img src='batt3.gif'><img src='batt4.gif'><img src='batt5.gif'></td></tr><tr><td>2x</td><td>Kreuzer</td><td><img src='batt1.gif'><img src='batt2.gif'><img src='batt3.gif'><img src='batt5.gif'></td></tr><tr><td>4x</td><td>Fregatte</td><td><img src='batt1.gif'><img src='battleships/batt2.gif'><img src='batt5.gif'></td></tr><tr><td>4x</td><td>Minensucher</td><td><img src='batt1.gif'><img src='batt5.gif'></td></tr></table>");
updateStatus();
